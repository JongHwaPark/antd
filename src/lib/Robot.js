...
export const start = async () => {
  try {
    const response = await httpClient.post('/robot/start', {});
    // console.log(data, response);
    return response;
...
export const pause = async () => {
  try {
    const response = await httpClient.post('/robot/pause', {});
    // console.log(data, response);
    return response;
...
export const getSchedule = async () => {
  try {
    return await httpClient.get(`/schedule`, {});
...
export const addSchedule = async (point) => {
  try {
    return await httpClient.post(`/schedule/job`, { job: point });
...
export const saveWall = async (data) => {
  try {
    return await httpClient.post(`/wall/save`, data);
